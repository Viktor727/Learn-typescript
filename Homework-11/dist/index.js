...
const Catch = (target, context) => {
    // const originalMethod = descriptor.value;
    // console.log("target", target);
    // console.log("key", key);
    // console.log("descriptor", descriptor);
    // console.log(originalMethod);
    // console.log(`Oops, there is an error in ${key}: ${key}`);
    const methodName = String(context.name);
    console.log(context);
    console.log("methodName", methodName);
    console.log(`Oops, there is an error in ${target.name}: ${""}`);
    try {
        ...
        console.log(2);
        // console.log("An error occurred:", target.message);
    }
};
let UsersService = (() => {
    var _a;
